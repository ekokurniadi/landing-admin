              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="col-md-4">
                      <?php echo anchor(site_url('service_rate/create'),'<i class="fa fa-plus"></i> Add New', 'class="btn btn-icon icon-left btn-primary"'); ?>
                    </div>
		...
		<th>Action</th>
                      ...
                      <tbody></tbody>
                          ...
                          dataTable = $('#example1').DataTable({
                              ...
                              "ajax": {
                                url: "<?php echo site_url('service_rate/fetch_data'); ?>",
                                type: "POST",
                                dataSrc: "data",
                                data: function(d) {
                                  return d;

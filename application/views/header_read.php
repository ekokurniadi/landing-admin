  ...
  <div class="row">
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <form class="form-horizontal">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="varchar">Favicon <?php echo form_error('favicon') ?></label>
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="favicon" id="favicon" placeholder="Favicon" value="<?php echo $favicon; ?>" readonly />
                </div>
              </div>
	    ...
	    <a href="<?php echo site_url('header') ?>" class="btn btn-icon icon-left btn-success">Cancel</a>

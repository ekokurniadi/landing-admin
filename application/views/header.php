          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="nav-link" href="<?php echo base_url('about_detail')?>">About Detail</a></li>
                  <li><a class="nav-link" href="<?php echo base_url('contact')?>">Contact</a></li>
                  <li><a class="nav-link" href="<?php echo base_url('feature')?>">Feature</a></li>
                  <li><a class="nav-link" href="<?php echo base_url('frequently_asked_questions')?>">FAQ</a></li>
                  <li><a class="nav-link" href="<?php echo base_url('galery')?>">Galery</a></li>
                  <li><a class="nav-link" href="<?php echo base_url('header')?>">Header</a></li>
                  <li><a class="nav-link" href="<?php echo base_url('hero')?>">Hero</a></li>
                  <li><a class="nav-link" href="<?php echo base_url('message')?>">Message</a></li>
                  <li><a class="nav-link" href="<?php echo base_url('pricing')?>">Pricing</a></li>
                  <li><a class="nav-link" href="<?php echo base_url('service')?>">Service</a></li>
                  <li><a class="nav-link" href="<?php echo base_url('service_rate')?>">Service Rate</a></li>
                  <li><a class="nav-link" href="<?php echo base_url('team')?>">Team</a></li>
                  <li><a class="nav-link" href="<?php echo base_url('testimoni')?>">Testimoni</a></li>
